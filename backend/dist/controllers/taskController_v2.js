...
async function createTask(req, res) {
    try {
        ...
        const taskCountResult = await (0, database_1.query)(`
    ...
    `, [daoId]);
        ...
        if (taskCount > 0) {
            const firstTaskResult = await (0, database_1.query)(`
...
async function updateTaskProgress(req, res) {
    try {
        ...
        const taskInfoResult = await (0, database_1.query)(`
...
async function deleteTask(req, res) {
    ...
    `, [id]);
        ...
        await (0, database_1.query)(`DELETE FROM task WHERE id = $1`, [id]);
        // 🎯 MISE À JOUR: Mettre à jour le statut du DAO
        await updateDaoStatus(taskInfo.dao_id);
        res.status(200).json({
            success: true,
...
async function updateDaoStatus(daoId) {
    try {
        ...
        const allTasksResult = await (0, database_1.query)(`
...
async function getDaoTasksStats(req, res) {
    try {
        const { id } = req.params;
...
//# sourceMappingURL=taskController_v2.js.map